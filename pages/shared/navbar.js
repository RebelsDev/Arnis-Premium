        ...
        <div className={styles.navbar}>
            <div className={styles.container}>
                ...
                <Link href="/">
                    <a>
                        <div className={styles.logo}>
                            <img src="/img/logo.svg" alt="Arnis Premium Logo" />
                        </div>
                ...
                <div className={styles.contact}>
                    <a href="https://www.instagram.com/arnis.premium/" target="_blank" rel="noopener noreferrer" aria-label='Arnis Premium Instagram'>
                    ...
                    <a href="https://www.facebook.com/Arnis.premium" target="_blank" rel="noopener noreferrer" aria-label='Arnis Premium Facebook'>
